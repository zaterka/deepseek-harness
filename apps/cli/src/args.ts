 ...
 *
 * `web` is a hardcoded alias for `--profile web`; `tui` aliases `--profile tui`;
...
Examples:
  ...
  dsh --profile tui                          boot the terminal profile (same as: dsh tui)
  dsh --profile tui --resume <session>       resume a persisted session in the terminal app
